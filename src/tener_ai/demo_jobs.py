    ...
    def _seed_dialogue_candidate(
        ...
        *,
        ...
        self.db.upsert_candidate_prescreen(
            ...
            salary_expectation_min=22000 + (global_index % 4) * 500,
            salary_expectation_max=24500 + (global_index % 4) * 500,
    ...
    def _seed_resume_candidate(
        ...
        *,
        ...
        self.db.upsert_candidate_prescreen(
            ...
            salary_expectation_min=23000 + (global_index % 4) * 500,
            salary_expectation_max=25500 + (global_index % 4) * 500,
            salary_expectation_currency="PLN",
            location_confirmed=True,
            work_authorization_confirmed=True,
            cv_received=True,
